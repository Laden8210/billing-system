...
<body class="bg-gray-100"> <!-- Added a background color -->
    ...
    <div class="flex justify-center items-center h-screen">
        <div class="border rounded shadow-lg px-8 py-6 bg-white" style="width: 500px;">
            ...
            <p class="text-gray-500 text-center mb-6">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Adipisci, cupiditate exercitationem fugit expedita temporibus nihil repellendus rem sapiente illum. Harum eius nemo provident. Ratione fugit ipsam blanditiis repudiandae veritatis sit?</p>
