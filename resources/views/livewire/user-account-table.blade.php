    ...
    <div class="w-full  flex justify-between">
        ...
        <div class="flex justify-start  w-1/2">
            ...
            <div class="w-1/3 px-2 self-end">
                <label for="" class="p-2">User Account</label>
        ...
        <table class="w-full table-auto border-collapse border border-slate-400">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="border border-slate-300">{{ $employee->contact_number}}</td>
                    <td class="border border-slate-300">{{ $employee->firstname ." ". $employee->middleinitial .". ". $employee->lastname}}</td>
                    <td class="border border-slate-300">{{$employee->password}}</td>
                    <td class="border border-slate-300">{{ $employee->role_id === 1? 'Admin' : 'Collector'}}</td>
                    <td class="border border-slate-300"> <i class="fa-solid fa-eye"> </i></td>
