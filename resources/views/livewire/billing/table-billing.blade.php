            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="border border-slate-300">{{
                            $bill->subscription->subscriber->sr_fname
                        }}</td>
                    ...
                    <td class="border border-slate-300 px-2">
                        <button class="bg-cyan-400 hover:bg-cyan-600 px-3 py-1 rounded-full text-slate-50 font-bold my-2"
                    ...
                    <div class="p-2">
                        <div class="flex justify-between">
                            <div class="w-full">
                                ...
                                <p class="font-bold">Subscriber Name: {{$selectedBilling->subscription->subscriber->sr_fname}} {{$selectedBilling->subscription->subscriber->sr_lname}}</p>
                                ...
                                <p class="font-bold">Subscription Plan: {{$selectedBilling->subscription->plan->snplan_bandwidth}}MBps Fibr</p>
                                <p class="font-bold">Subscription Fee: {{$selectedBilling->subscription->plan->snplan_fee}}</p>

                                <p  class="font-bold">Status: {{
                                    $selectedBilling->bs_status == 'unpaid' ? 'Unpaid' : 'Paid'
                                    }}</p>
                            </div>
                        </div>
                    </div>
