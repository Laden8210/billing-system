<div class="p-2 w-full">
    ...
    <div class="w-full mt-5">
        ...
        <div class="flex justify-between">
            ...
            <div class="flex justify-start items-center">
                ...
                x-data x-on:click="$dispatch('open-modal', {name:'update-user-modal'})" >Update</button>
            </div>
        </div>
    ...
    <x-modal-form name="update-user-modal" title='Update Subcriber'>
            ...
            <form wire:submit.prevent="save">
                ...
                <div class="grid grid-cols-2 gap-x-2 gap-y-5">
                    <div class="col-span-2">
                        ...
                        @if (session()->has('error'))
                            <div class="w-full py-2 px-2 bg-red-200 rounded">
                                <span class="text-red-400">{{ session('error') }}</span>
                            </div>
                        @endif
                    </div>
