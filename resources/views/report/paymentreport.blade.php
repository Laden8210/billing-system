...
<body>
    <div class="container">
            ...
            <tbody>
                @foreach ($payments as $payment)
                    <tr>
                        ...
                        <td>{{ $payment->billingStatement->subscription->sn_num }}</td>
                        <td>{{ $payment->billingStatement->subscription->plan->snplan_bandwidth }}</td>
                        <td><span style="font-family: DejaVu Sans;">&#x20B1;</span>{{ $payment->p_amount }}</td>
        ...
        <p class="total-amount"><strong>Total Amount Collected:</strong> <span style="font-family: DejaVu Sans;">&#x20B1;</span></strong> {{ $payments->sum('p_amount') }}</p>
